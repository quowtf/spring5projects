...
import quo.wtf.worldgdp.mapper.CountryRowMapper;
...
public class CountryDAO {
	...
	public List<Country> getCountries(Map<String, Object> params) {
		...
		return namedParamJdbcTemplate.query(SELECT_CLAUSE + " WHERE 1 = 1 "
				...
				+ (!StringUtils.isEmpty((String) params.get("region")) ? REGION_WHERE_CLAUSE : "") + PAGINATION_CLAUSE,
